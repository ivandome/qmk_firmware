...
## Compile and flash for promicro_rp2040

```sh
# Compile only
qmk compile -kb splitkb/kyria/rev3 -km ivandome_rev3 -e CONVERT_TO=promicro_rp2040

# Compile and flash
qmk flash -kb splitkb/kyria/rev3 -km ivandome_rev3 -e CONVERT_TO=promicro_rp2040
```
